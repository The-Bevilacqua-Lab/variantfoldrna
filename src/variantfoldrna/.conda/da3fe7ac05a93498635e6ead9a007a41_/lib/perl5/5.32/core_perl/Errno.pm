...
"x86_64-linux-thread-multi-6.2.0-1018-azure" or
	die "Errno architecture (x86_64-linux-thread-multi-6.2.0-1018-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
